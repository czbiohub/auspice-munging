...
* `munge.py` contains functions for modifying foibles of the GISAID metadata (such as the Grand Princess cruise ship, or various spellings of the same county), and adds new metadata back to the JSON.
